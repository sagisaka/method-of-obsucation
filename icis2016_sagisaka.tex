...
\begin{figure}[bt]
  ...
  \begin{minipage}[b]{0.48\linewidth}
    ...
    \subcaption{Original}\label{fig:asm-5gram-original-histogram}%
  \end{minipage}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/ALL_ASM}%
    \subcaption{ALL}\label{fig:asm-5gram-ALL-histogram}%
  \end{minipage}\vspace{0.5cm}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/DR_ASM}%
    \subcaption{DR}\label{fig:asm-5gram-DR-histogram}%
  \end{minipage}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/IRR_ASM}%
    \subcaption{IRR}\label{fig:asm-5gram-IRR-histogram}%
  \end{minipage}\vspace{0.5cm}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/MLI_ASM}%
    \subcaption{MLI}\label{fig:asm-5gram-MLI-histogram}%
  \end{minipage}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/PG_ASM}%
    \subcaption{PG}\label{fig:asm-5gram-PG-histogram}%
  \end{minipage}
...
\begin{figure}[bt]
  ...
  \begin{minipage}[b]{0.48\linewidth}
    ...
    \subcaption{Original}\label{fig:junit-5gram-original-histogram}%
  \end{minipage}
  \begin{minipage}[b]{0.48\linewidth}
    \includegraphics[clip,width=1.0\columnwidth]{images/MLI_junit}%
    \subcaption{MLI}\label{fig:junit-5gram-ALL-histogram}%
  \end{minipage}\vspace{0.5cm}
